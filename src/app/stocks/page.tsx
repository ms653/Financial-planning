...
/**
 * Phase 4, Milestone 1 — the watchlist. Milestone 2 adds the one thing this page was
 * deliberately missing at first: each ticker now links to `/stocks/[ticker]`, where the
 * DCF calculator lives. Still no relative-valuation/checklist content on this list page
 * itself (Milestones 3–4) — this page's own job stays "the watchlist," not "the whole
 * workbench."
 */
  ...
  return (
    <AppShell pathname="/stocks">
      ...
      <p className="mt-2.5 max-w-prose text-sm leading-relaxed text-content-muted">
        ...
        hold (see Portfolio for that). Click a ticker for its DCF calculator; relative
        valuation and a fundamentals checklist are coming in later milestones.
      </p>
            ...
            {watchlist.map((item) => (
              ...
              >
                <Link
                  ...
                  className="text-sm font-medium tabular text-content underline-offset-2 hover:underline"
                >
                  {item.ticker}
                </Link>
